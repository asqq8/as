...
var app = getApp();
var http_url = app.globalData.http_api + "s=article&c=show";
http_url+= '&api_call_function=';
var member_url = app.globalData.http_api + "s=api&app=article&c=module&api_auth_code=" + wx.getStorageSync('member_auth') + "&api_auth_uid=" + wx.getStorageSync('member_uid');
